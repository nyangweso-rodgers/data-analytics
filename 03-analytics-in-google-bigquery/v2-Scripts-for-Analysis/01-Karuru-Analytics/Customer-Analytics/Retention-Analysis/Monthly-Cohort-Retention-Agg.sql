...
cohort_size as (
                ...
                group by 1,2,3,4
                order by country_code,cohort_year, cohort_month
                ),
outlets_activites as (
                      ...
                      group by 1,2,3,4,5
                      order by country_code,monthly_dns.outlet_id, month_number
                      ),
cohort_retention as (
                      ...
                      sum(outlets_activites.monthly_gmv) as monthly_gmv
                      from outlets_activites
                      left join cohort_size on outlets_activites.cohort_year = cohort_size.cohort_year and outlets_activites.cohort_month = cohort_size.cohort_month and outlets_activites.country_code = cohort_size.country_code
                      group by 1,2,3,4,6,7,8
                      order by country_code, cohort_year, cohort_month, month_number
                      )
