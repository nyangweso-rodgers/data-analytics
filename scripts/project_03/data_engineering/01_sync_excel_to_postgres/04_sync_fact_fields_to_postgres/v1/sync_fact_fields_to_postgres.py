...
POSTGRES_TABLE_CONFIGS = {
    "target_table_name": "raw_fact_fields",
...
FILE_PATH = "../../../../../../../../Fact_Fields.xlsx - query_15.csv"  #TODO: Update with actual file path or pass as argument

# Field mapping: column_name -> postgres_data_type
FIELD_MAPPING = {
    'customer_id': 'INTEGER',
    'accountref': 'DOUBLE PRECISION',  # Original: accountRef
    'deviceid': 'VARCHAR(255)',  # Original: deviceId
}
