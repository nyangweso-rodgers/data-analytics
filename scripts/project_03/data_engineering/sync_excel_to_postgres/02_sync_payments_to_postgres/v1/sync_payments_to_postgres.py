...
POSTGRES_TABLE_CONFIGS = {
    "target_table_name": "raw_payments",
...
FILE_PATH = "../../../../../../../../Payment_data.csv"  #TODO: Update with actual file path or pass as argument

# Field mapping: column_name -> postgres_data_type
FIELD_MAPPING = {
    'query1_accountref': 'DOUBLE PRECISION',  # Original: Query1_accountRef
    'query1_paymentid': 'VARCHAR(100)',  # Original: Query1_paymentId
    #'query1_payernumber': 'VARCHAR(500)',  # Original: Query1_payerNumber
    #'query1_phonenumber': 'VARCHAR(50)',  # Original: Query1_phoneNumber
    'query1_timestampmade': 'VARCHAR(50)',  # Original: Query1_timestampMade
    'query1_status': 'VARCHAR(50)',  # Original: Query1_status
    'query1_expecteddate': 'VARCHAR(50)',  # Original: Query1_expectedDate
    'query1_expectedamount': 'INTEGER',  # Original: Query1_expectedAmount
    'query1_amtpaid': 'INTEGER',  # Original: Query1_amtPaid
    'query1_paymentsequence': 'INTEGER',  # Original: Query1_paymentSequence
    'query1_deviceid': 'VARCHAR(100)',  # Original: Query1_deviceId
    #'total': 'INTEGER',  # Original: Total
    #'total_1': 'BIGINT',  # Original: Total.1
    #'total_2': 'DOUBLE PRECISION',  # Original: Total.2
    #'total_3': 'INTEGER',  # Original: Total.3
}


# Column rename mapping (if needed for reading CSV)
COLUMN_RENAME_MAPPING = {
    'Query1_accountRef': 'query1_accountref',
    'Query1_paymentId': 'query1_paymentid',
    #'Query1_payerNumber': 'query1_payernumber',
    #'Query1_phoneNumber': 'query1_phonenumber',
    'Query1_timestampMade': 'query1_timestampmade',
    'Query1_status': 'query1_status',
    'Query1_expectedDate': 'query1_expecteddate',
    'Query1_expectedAmount': 'query1_expectedamount',
    'Query1_amtPaid': 'query1_amtpaid',
    'Query1_paymentSequence': 'query1_paymentsequence',
    'Query1_deviceId': 'query1_deviceid',
    #'Total': 'total',
    #'Total.1': 'total_1',
    #'Total.2': 'total_2',
    #'Total.3': 'total_3',
