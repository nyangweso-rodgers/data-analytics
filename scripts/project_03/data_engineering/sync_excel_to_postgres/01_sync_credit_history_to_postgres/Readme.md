...
```sh
    python sync_credit_history.py
```

- This will:
  - Read data from the default file path
...
```sh
    python sync_credit_history.py --file /path/to/your/file.csv
```

# Truncate Before Insert

- To clear the table before inserting new data:
  ```sh
    python sync_credit_history.py --truncate
  ```

# Custom Batch Size

```sh
    python sync_credit_history.py --batch-size 5000
```

# Combined Options

```sh
    python sync_credit_history.py --file data.xlsx --truncate --batch-size 5000
```
