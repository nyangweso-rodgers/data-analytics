...
POSTGRES_TABLE_CONFIGS = {
    "target_table_name": "raw_credit_history",  # TODO: Update with actual table name
...
FILE_PATH = "../../../../../../../../Credit History (Amortization Schedule) (1).csv"  #TODO: Update with actual file path or pass as argument
...
FIELD_MAPPING = {
    ...
    'schedule_account_ref': 'DOUBLE PRECISION',
    'schedule_customer_names': 'VARCHAR(50)',
    'schedule_installment_date': 'DATE',
    'schedule_product': 'VARCHAR(50)',
    'schedule_company_region': 'VARCHAR(50)',
    'premises_region': 'VARCHAR(50)',
    'schedule_status': 'VARCHAR(50)',
    'schedule_status_change': 'VARCHAR(50)',
    'schedule_month_started': 'DATE',
    'schedule_credit_sale': 'DOUBLE PRECISION',
    'schedule_downpayment_amount': 'DOUBLE PRECISION',
    'schedule_credit_sale_net': 'DOUBLE PRECISION',
    'schedule_installment_amount': 'DOUBLE PRECISION',
    'schedule_total_number_payments': 'INTEGER',
    'schedule_amount_due': 'DOUBLE PRECISION',
    'schedule_cumulative_total_month': 'DOUBLE PRECISION',
    'schedule_net_cumulative_total_month': 'DOUBLE PRECISION',
    'schedule_balance': 'DOUBLE PRECISION',
    'schedule_expected_payment': 'DOUBLE PRECISION',
    'cum_repaid': 'DOUBLE PRECISION',  # Original: cum_Repaid
    'schedule_arrears': 'DOUBLE PRECISION',
    'schedule_days_late': 'INTEGER',
    'cum_at_risk': 'DOUBLE PRECISION',  # Original: cum_At_Risk
    'cum_overdue_account': 'INTEGER',
    'cum_arrears_30days': 'VARCHAR(50)',
    'cum_current_no_arrears': 'DOUBLE PRECISION',
    'cum_balance_30_days_late_': 'VARCHAR(50)',
    'cum_expected_amount': 'DOUBLE PRECISION',
    'schedule_month_installment_paid2': 'DOUBLE PRECISION',
    'schedule_month_paid': 'DOUBLE PRECISION',
    'cum_collected': 'DOUBLE PRECISION',  # Original: cum_Collected
}


# Column rename mapping (if needed for reading CSV)
COLUMN_RENAME_MAPPING = {
    'cum_Repaid': 'cum_repaid',
    'cum_At_Risk': 'cum_at_risk',
    'cum_Collected': 'cum_collected',
}
