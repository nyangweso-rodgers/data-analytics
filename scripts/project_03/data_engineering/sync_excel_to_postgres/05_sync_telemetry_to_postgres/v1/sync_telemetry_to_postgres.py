...
POSTGRES_TABLE_CONFIGS = {
    "target_table_name": "raw_telemetry_data_2025",
...
FILE_PATH = "../../../../../../../../Details - SunCulture/data-unified-credit-score-model/iot/2025-Data.xlsx"  #TODO: Update with actual file path or pass as argument

# Field mapping: column_name -> postgres_data_type
FIELD_MAPPING = {
    'timestamp': 'VARCHAR(100)',
    'meterid': 'VARCHAR(255)',  # Original: meterId
    'hoursused': 'DOUBLE PRECISION',  # Original: HoursUsed
    'energyconsumptionkwh': 'DOUBLE PRECISION',  # Original: energyConsumptionKwh
}
