...
# ============================================================================
excel_file_path = "../../../../../../data/August Assignments .xlsx"
...
# ============================================================================
MYSQL_TABLE_CONFIG = {
    "table_name": "collection_officer_assignment_base",
    "batch_size": 1000,
...
def transform_rows(df: pd.DataFrame) -> List[Dict[str, Any]]:
    ...
    assignment_start = _resolve_default(SYNC_METADATA_COLUMNS["assignment_start"]["default"])
    assignment_end = _resolve_default(SYNC_METADATA_COLUMNS["assignment_end"]["default"])
