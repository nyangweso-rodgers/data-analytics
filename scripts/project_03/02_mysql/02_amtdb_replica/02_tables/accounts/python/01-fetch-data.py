...
DB_NAME = os.getenv("mysql_amt_replica_db_name")
DB_USER = os.getenv("mysql_amt_replica_db_user")
DB_PASSWORD = os.getenv("mysql_amt_replica_db_password")
DB_HOST = os.getenv("mysql_amt_replica_db_host")
...
def main():
    ...
    db_table_field_names = "id, customerId, accountRef, status"
