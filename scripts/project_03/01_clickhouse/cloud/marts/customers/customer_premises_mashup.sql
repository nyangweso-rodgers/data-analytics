...
--------------------- Premises Mashup ----------------------------------
customer_premises_mashup_cte as (
    select *
    from (
        select distinct customers_cte.id as customerId,
        --premises_cte.customer_id as customer_id,
    countries_cte.country_name as country,
    regions_cte.region_name as region,
    --state_type,
    ...
    premise_details_cte.latitude as latitude,
    premise_details_cte.longitude as longitude
    from customers_cte
...
--------------------- Data Quality - Check Duplicate Premises ----------------------------------
check_duplicate_customer_premises_cte as (
    select distinct customerId,
    count(*) as recordCount
    from customer_premises_mashup_cte
    GROUP BY 1
...
from customer_premises_mashup_cte
--from check_duplicate_customer_premises_cte
--ORDER BY 1,2,3,4
--limit 1000