...
SmileIdentity_JSON__c = EXCLUDED.SmileIdentity_JSON__c,
...
'SmileIdentity_JSON__c': lead.get('SmileIdentity_JSON__c'),
...
'Last_Assigned_Agent_Number__c': lead.get('Last_Assigned_Agent_Number__c')
        } for lead in leads]
