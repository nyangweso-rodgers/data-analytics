...
sales_reconciliation_report as (
                                ...
                                dni.gmv_vat_incl,
                                /*case
                                  when dni.delivery_note_item_index = 1 then dnsa.settlement_amount
                                ...
                                left join dns_items dni on dt.id = dni.delivery_trip_id and dt.delivery_note_id = dni.id
